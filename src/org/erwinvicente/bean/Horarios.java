...
public class Horarios {
    ...
    public Horarios(int aInt, String string, String string0) {

}

    public Horarios(int aInt, String string, Time time, Time time0, boolean aBoolean, boolean aBoolean0, boolean aBoolean1, boolean aBoolean2, boolean aBoolean3) {
    }
